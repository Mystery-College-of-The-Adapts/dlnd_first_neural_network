...
# 
# #### 请将你的答案填写在下方
# 1.模型预测效果基本拟合，Training loss: 0.051  Validation loss: 0.141
# 
# 2.问题：Validation loss 很高
# 
# 3.经过多次训练和请教助教，自己阅读分析训练网络要注意的事项，问题出在学习率较低、迭代次数少以及隐藏节点少。
# 
# 4.改进：提高了学习率和迭代次数，以及查看了数据表格，增加了隐藏层节点数。
